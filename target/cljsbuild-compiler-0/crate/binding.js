...
var self__ = this;
var G__5661 = cljs.core.seq.call(null,self__.watches);
while(true){
if(G__5661)
{var vec__5662 = cljs.core.first.call(null,G__5661);
var key__$1 = cljs.core.nth.call(null,vec__5662,0,null);
var f = cljs.core.nth.call(null,vec__5662,1,null);
f.call(null,key__$1,this$,oldval,newval);
{
var G__5663 = cljs.core.next.call(null,G__5661);
G__5661 = G__5663;
continue;
}
} else
...
var vec__5665 = ((cljs.core.instance_QMARK_.call(null,crate.binding.SubAtom,atm))?cljs.core.PersistentVector.fromArray([atm.atm,cljs.core.concat.call(null,atm.path,path__$1)], true):cljs.core.PersistentVector.fromArray([atm,path__$1], true));
var atm__$1 = cljs.core.nth.call(null,vec__5665,0,null);
var path__$2 = cljs.core.nth.call(null,vec__5665,1,null);
...
var G__5666__delegate = function (sa,f,x,y,z,more){
return crate.binding.sub_reset_BANG_.call(null,sa,cljs.core.apply.call(null,f,cljs.core.deref.call(null,sa),x,y,z,more));
};
var G__5666 = function (sa,f,x,y,z,var_args){
var more = null;
if (goog.isDef(var_args)) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 5),0);
} 
return G__5666__delegate.call(this, sa, f, x, y, z, more);
};
G__5666.cljs$lang$maxFixedArity = 5;
G__5666.cljs$lang$applyTo = (function (arglist__5667){
var sa = cljs.core.first(arglist__5667);
var f = cljs.core.first(cljs.core.next(arglist__5667));
var x = cljs.core.first(cljs.core.next(cljs.core.next(arglist__5667)));
var y = cljs.core.first(cljs.core.next(cljs.core.next(cljs.core.next(arglist__5667))));
var z = cljs.core.first(cljs.core.next(cljs.core.next(cljs.core.next(cljs.core.next(arglist__5667)))));
var more = cljs.core.rest(cljs.core.next(cljs.core.next(cljs.core.next(cljs.core.next(arglist__5667)))));
return G__5666__delegate(sa, f, x, y, z, more);
});
...
var self__ = this;
var G__5668 = cljs.core.seq.call(null,self__.watches);
while(true){
if(G__5668)
{var vec__5669 = cljs.core.first.call(null,G__5668);
var key__$1 = cljs.core.nth.call(null,vec__5669,0,null);
var f = cljs.core.nth.call(null,vec__5669,1,null);
f.call(null,key__$1,this$,oldval,newval);
{
var G__5670 = cljs.core.next.call(null,G__5668);
G__5668 = G__5670;
continue;
}
} else
...
var G__5672_5673 = cljs.core.seq.call(null,atms);
while(true){
if(G__5672_5673)
{var atm_5674 = cljs.core.first.call(null,G__5672_5673);
cljs.core.add_watch.call(null,atm_5674,k,((function (G__5672_5673,atm_5674){
return (function (_,___$1,___$2,___$3){
return crate.binding._compute.call(null,neue);
});})(G__5672_5673,atm_5674))
);
{
var G__5675 = cljs.core.next.call(null,G__5672_5673);
G__5672_5673 = G__5675;
continue;
}
} else
{}
...
return cljs.core.filter.call(null,(function (p1__5676_SHARP_){
return (p1__5676_SHARP_ > 100);
}),y);
}));
...
var self__ = this;
var G__5677 = cljs.core.seq.call(null,self__.watches);
while(true){
if(G__5677)
{var vec__5678 = cljs.core.first.call(null,G__5677);
var key = cljs.core.nth.call(null,vec__5678,0,null);
var f = cljs.core.nth.call(null,vec__5678,1,null);
f.call(null,key,this$,oldval,newval);
{
var G__5679 = cljs.core.next.call(null,G__5677);
G__5677 = G__5679;
continue;
}
} else
...
var self__ = this;
return cljs.core.add_watch.call(null,self__.notif,cljs.core.gensym.call(null,"bound-coll"),(function (_,___$1,___$2,p__5680){
var vec__5681 = p__5680;
var event = cljs.core.nth.call(null,vec__5681,0,null);
var el = cljs.core.nth.call(null,vec__5681,1,null);
var v = cljs.core.nth.call(null,vec__5681,2,null);
...
__GT_path.cljs$lang$applyTo = (function (arglist__5682){
var bc = cljs.core.first(arglist__5682);
var segs = cljs.core.rest(arglist__5682);
...
var G__5685_5687 = cljs.core.seq.call(null,added);
while(true){
if(G__5685_5687)
{var a_5688 = cljs.core.first.call(null,G__5685_5687);
crate.binding.bc_add.call(null,bc,a_5688,a_5688);
{
var G__5689 = cljs.core.next.call(null,G__5685_5687);
G__5685_5687 = G__5689;
continue;
}
} else
{}
...
var G__5686 = cljs.core.seq.call(null,removed);
while(true){
if(G__5686)
{var r = cljs.core.first.call(null,G__5686);
crate.binding.bc_remove.call(null,bc,r);
{
var G__5690 = cljs.core.next.call(null,G__5686);
G__5686 = G__5690;
continue;
}
} else
...
var bound_coll__delegate = function (atm,p__5691){
var vec__5694 = p__5691;
var path = cljs.core.nth.call(null,vec__5694,0,null);
var opts = cljs.core.nth.call(null,vec__5694,1,null);
var vec__5695 = (cljs.core.truth_(opts)?cljs.core.PersistentVector.fromArray([path,opts], true):cljs.core.PersistentVector.fromArray([null,path], true));
var path__$1 = cljs.core.nth.call(null,vec__5695,0,null);
var opts__$1 = cljs.core.nth.call(null,vec__5695,1,null);
...
var p__5691 = null;
if (goog.isDef(var_args)) {
  p__5691 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return bound_coll__delegate.call(this, atm, p__5691);
};
bound_coll.cljs$lang$maxFixedArity = 1;
bound_coll.cljs$lang$applyTo = (function (arglist__5696){
var atm = cljs.core.first(arglist__5696);
var p__5691 = cljs.core.rest(arglist__5696);
return bound_coll__delegate(atm, p__5691);
});
...
var map_bound__delegate = function (as,atm,p__5697){
var vec__5699 = p__5697;
var opts = cljs.core.nth.call(null,vec__5699,0,null);
...
var p__5697 = null;
if (goog.isDef(var_args)) {
  p__5697 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return map_bound__delegate.call(this, as, atm, p__5697);
};
map_bound.cljs$lang$maxFixedArity = 2;
map_bound.cljs$lang$applyTo = (function (arglist__5700){
var as = cljs.core.first(arglist__5700);
var atm = cljs.core.first(cljs.core.next(arglist__5700));
var p__5697 = cljs.core.rest(cljs.core.next(arglist__5700));
return map_bound__delegate(as, atm, p__5697);
});
...
{return G__5702.crate$binding$bindable$;
}
})()))
{return true;
} else
{if((!G__5702.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,crate.binding.bindable,G__5702);
} else
{return false;
}
}
...
{return G__5704.crate$binding$bindable_coll$;
}
})()))
{return true;
} else
{if((!G__5704.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,crate.binding.bindable_coll,G__5704);
} else
{return false;
}
}
...
var G__5706 = atm;
if(G__5706)
{if((function (){var or__3824__auto__ = (G__5706.cljs$lang$protocol_mask$partition0$ & 32768);
if(or__3824__auto__)
{return or__3824__auto__;
} else
{return G__5706.cljs$core$IDeref$;
}
})())
{return true;
} else
{if((!G__5706.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IDeref,G__5706);
} else
{return false;
}
}
...
var bound__delegate = function (atm,p__5707){
var vec__5709 = p__5707;
var func = cljs.core.nth.call(null,vec__5709,0,null);
...
var p__5707 = null;
if (goog.isDef(var_args)) {
  p__5707 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return bound__delegate.call(this, atm, p__5707);
};
bound.cljs$lang$maxFixedArity = 1;
bound.cljs$lang$applyTo = (function (arglist__5710){
var atm = cljs.core.first(arglist__5710);
var p__5707 = cljs.core.rest(arglist__5710);
return bound__delegate(atm, p__5707);
});
