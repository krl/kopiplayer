...
kopiplayer.message = function() {
  var a = function(a) {
    console.log([cljs.core.str("message "), cljs.core.str(a)].join(""));
    return kopiplayer.websocket.send(cljs.core.js__GT_clj.call(null, cljs.core.vec.call(null, a)))
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
kopiplayer.letter_box_tpl = function(a) {
  a = crate.core.html.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.letterbox", cljs.core.PersistentVector.fromArray(["\ufdd0'div.letter_separator", cljs.core.PersistentVector.fromArray(["\ufdd0'h1.letter", a], !0)], !0)], !0));
  a.setAttribute("crateGroup", group__3384__auto___11448);
  return a
};
...
kopiplayer.artist_entry_tpl = function(a) {
  a = crate.core.html.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'h2", cljs.core.ObjMap.fromObject(["\ufdd0'data-value"], {"\ufdd0'data-value":a}), (new cljs.core.Keyword("\ufdd0'name")).call(null, a)], !0));
  a.setAttribute("crateGroup", group__3384__auto___11449);
  return a
};
...
kopiplayer.recording_tpl = function(a) {
  a = crate.core.html.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'tr", cljs.core.ObjMap.fromObject(["\ufdd0'data-value"], {"\ufdd0'data-value":a}), cljs.core.PersistentVector.fromArray(["\ufdd0'td", cljs.core.PersistentVector.fromArray(["\ufdd0'b", (new cljs.core.Keyword("\ufdd0'number")).call(null, a)], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'td", (new cljs.core.Keyword("\ufdd0'title")).call(null, a)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'td", (new cljs.core.Keyword("\ufdd0'length")).call(null, 
  a)], !0)], !0));
  a.setAttribute("crateGroup", group__3384__auto___11450);
  return a
};
kopiplayer.recording_tpl.prototype._crateGroup = group__3384__auto___11450;
jayq.core.delegate.call(null, kopiplayer.$body, kopiplayer.recording_tpl, "\ufdd0'click", function(a) {
  a.preventDefault();
  a = cljs.reader.read_string.call(null, jayq.core.data.call(null, jayq.core.$.call(null, this), "\ufdd0'value"));
  return kopiplayer.message.call(null, "\ufdd0'play-recording", (new cljs.core.Keyword("\ufdd0'id")).call(null, a))
});
jayq.core.delegate.call(null, kopiplayer.$body, kopiplayer.artist_entry_tpl, "\ufdd0'click", function(a) {
  a.preventDefault();
  a = cljs.reader.read_string.call(null, jayq.core.data.call(null, jayq.core.$.call(null, this), "\ufdd0'value"));
  return kopiplayer.message.call(null, "\ufdd0'artist-info", (new cljs.core.Keyword("\ufdd0'id")).call(null, a))
});
var group__3384__auto___11455 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
kopiplayer.artist_info_tpl = function(a) {
  a = crate.core.html.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", cljs.core.PersistentVector.fromArray(["\ufdd0'h1", (new cljs.core.Keyword("\ufdd0'name")).call(null, a)], !0), function c(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var e = cljs.core.first.call(null, a);
          return cljs.core.cons.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", cljs.core.PersistentVector.fromArray(["\ufdd0'h2", (new cljs.core.Keyword("\ufdd0'title")).call(null, e), cljs.core.PersistentVector.fromArray(["\ufdd0'p.date", (new cljs.core.Keyword("\ufdd0'date")).call(null, e)], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'table", cljs.core.map.call(null, kopiplayer.recording_tpl, (new cljs.core.Keyword("\ufdd0'recordings")).call(null, e))], !0)], !0), c.call(null, 
          cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
  }.call(null, (new cljs.core.Keyword("\ufdd0'releases")).call(null, a))], !0));
  a.setAttribute("crateGroup", group__3384__auto___11455);
  return a
};
kopiplayer.artist_info_tpl.prototype._crateGroup = group__3384__auto___11455;
kopiplayer.display_artists = function(a) {
  for(a = cljs.core.seq.call(null, a);;) {
    if(a) {
      for(var b = cljs.core.first.call(null, a), c = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nth.call(null, b, 1, null), c = jayq.core.$.call(null, kopiplayer.letter_box_tpl.call(null, cljs.core.name.call(null, c))), b = cljs.core.seq.call(null, b);;) {
        if(b) {
          var d = cljs.core.first.call(null, b);
          jayq.core.append.call(null, c, kopiplayer.artist_entry_tpl.call(null, d));
          b = cljs.core.next.call(null, b)
        }else {
          break
        }
      }
      jayq.core.append.call(null, kopiplayer.$artists, c);
      a = cljs.core.next.call(null, a)
    }else {
      return null
    }
...
kopiplayer.display_artist_info = function(a) {
  return jayq.core.append.call(null, jayq.core.inner.call(null, kopiplayer.$artist_info, ""), kopiplayer.artist_info_tpl.call(null, a))
};
kopiplayer.play_recording = function(a) {
  jayq.core.attr.call(null, kopiplayer.$audio, "\ufdd0'src", [cljs.core.str("/play/"), cljs.core.str(a)].join(""));
  return cljs.core.first.call(null, kopiplayer.$audio).play()
};
kopiplayer.handle_message = function(a) {
  var b = cljs.core.nth.call(null, a, 0, null), a = cljs.core.nthnext.call(null, a, 1);
  console.log(cljs.core.print_str.call(null, "handle-message", b));
  if(cljs.core._EQ_.call(null, "\ufdd0'play", b)) {
    return kopiplayer.play_recording.call(null, cljs.core.first.call(null, a))
  }
  if(cljs.core._EQ_.call(null, "\ufdd0'artists", b)) {
    return kopiplayer.display_artists.call(null, cljs.core.first.call(null, a))
  }
  if(cljs.core._EQ_.call(null, "\ufdd0'artist-info", b)) {
    return kopiplayer.display_artist_info.call(null, cljs.core.first.call(null, a))
  }
...
kopiplayer.websocket.onmessage = function(a) {
  return kopiplayer.handle_message.call(null, cljs.reader.read_string.call(null, a.data))
};
